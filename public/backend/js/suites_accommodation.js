...
var ids = [];
var created_at;
var SuitesAccommodation = function () {
    ...
    var handleReport = function () {
        $('.btn-report').on('click', function () {
            ...
            var url = config.admin_url + "/suites_accommodation";
            var params = {};
    ...
    var handleAddOrRemoveItem = function () {
        ...
        $('.add-suite').on('click', function () {
            ...
            for (var x = 0; x < suites.length; x++) {
                var obj = suites[x];
                var disabled = '';
                var selected_suites = getSelectedSuites();
    ...
    var getSelectedSuites = function () {
        var suites = [];
    ...
    var getlounges = function (ele, suite) {
        ...
        setTimeout(function () {
            $.get('' + config.admin_url + '/suites_accommodation/lounges/' + suite, function (data) {
                var html = '';
...
//                },
            ...
            $('#regForm').submit(function () {
                ...
                $.ajax({
                    url: config.admin_url + "/suites_accommodation",
                    type: 'POST',
                    dataType: 'json',
                    data: formData,
                    async: false,
    ...
    return {
        ...
        delete: function (t) {
            ...
            setTimeout(function () {
                $.ajax({
                    url: config.admin_url + '/suites_accommodation/delete',
        ...
        notify: function (ele) {
            ...
            setTimeout(function () {
                $.ajax({
                    url: config.admin_url + "/suites_accommodation/notify",
                    type: 'POST',
                    dataType: 'json',
                    data: {
