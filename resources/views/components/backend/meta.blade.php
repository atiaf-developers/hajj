...
<script>
    ...
    var lang = {
        generate_qr_code: "{{ _lang('app.generate_qr_code')}}",
        send_notification: "{{ _lang('app.send_notification')}}",
        rooms: "{{ _lang('app.rooms')}}",
        building: "{{ _lang('app.building')}}",
        floor: "{{ _lang('app.floor')}}",
        buildings: "{{ _lang('app.buildings')}}",
        suite: "{{ _lang('app.suite')}}",
        suite: "{{ _lang('app.suite')}}",
        lounges: "{{ _lang('app.lounges')}}",
        next: "{{ _lang('app.next')}}",
