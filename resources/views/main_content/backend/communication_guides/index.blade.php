...
<li><span> {{_lang('app.communication_guides')}}</span></li>
        ...
        <!--Table Wrapper Start-->
          <div class="table-toolbar">
            <div class="row">
                <div class="col-md-6">
                    <div class="btn-group">
                        <a class="btn green" style="margin-bottom: 40px;" href="{{route('communication_guides.create')}}">{{ _lang('app.add_new')}}<i class="fa fa-plus"></i> </a>
                    </div>
                </div>
            </div>
        </div>
