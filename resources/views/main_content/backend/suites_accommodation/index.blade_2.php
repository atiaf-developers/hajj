...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="pull-right">
            <a href="{{ route('suites_accommodation.create') }}" class="btn btn-circle btn-danger" onclick="SuitesAccommodation.delete(this);
                                return false;">
                <i class="fa fa-remove"></i> {{_lang('app.delete')}} </a>
            <a href="{{ route('suites_accommodation.create') }}" class="btn btn-circle btn-default">
                ...
                <table class = "table table-responsive table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{_lang('app.suite')}}</th>
                            <th>{{_lang('app.lounge')}}</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$one->suite_number}}</td>
                            <td>{{$one->lounge_number}}</td>
                            <td>{{$one->lounge_seat_number}}</td>
