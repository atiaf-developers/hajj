        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                ...
                <div class="form-group form-md-line-input col-md-4">
                    <input type="number" class="form-control" id="bus_number" name="bus_number" value="">
                    <label for="title">{{_lang('app.bus_number') }}</label>
                    <span class="help-block"></span>
                </div>

                <div class="form-group form-md-line-input col-md-4">
                    <input type="number" class="form-control" id="num_of_seats" name="num_of_seats" value="">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                ...
                <div class="form-group form-md-line-input col-md-4">
                    <input type="text" class="form-control" id="supervisor_username" name="supervisor_username" value="">
                ...
                <div class="form-group form-md-line-input col-md-5">
                    <input type="text" class="form-control" id="supervisor_contact_numbers" name="supervisor_contact_numbers" value="" placeholder="+966663635,+96651515156,....">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="supervisor_image_box">
                        <img src="{{url('no-image.png')}}" width="100" height="80" class="supervisor_image" />
                    </div>
