...
<li><a href="{{url('admin/commen/')}}">{{_lang('app.common_questions')}}</a> <i class="fa fa-circle"></i></li>
<li><span> {{_lang('app.add_common_questions')}}</span></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group form-md-line-input col-md-12">
                            <input type="text" class="form-control" id="question[{{ $key }}]" name="question[{{ $key }}]" value="">
