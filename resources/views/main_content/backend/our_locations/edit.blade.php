...
<li><span> {{_lang('app.edit_location')}}</span></li>
@endsection
...
<form role="form"  id="addEditOurLocationsForm" enctype="multipart/form-data">
            ...
            <div class="form-body">
                <div class="form-group form-md-line-input col-md-3">
                    <select class="form-control edited" id="active" name="active">
                        <option {{ $location->active == 1 ? 'selected' : '' }} value="1">{{ _lang('app.active') }}</option>
                        <option {{ $location->active == 0 ? 'selected' : '' }}  value="0">{{ _lang('app.not_active') }}</option>
                    </select>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                <div class="form-body">
                   <div class="form-group col-md-6">
                    ...
                    <div class="location_image_box">
                        <img src="{{url('public/uploads/our_locations').'/'.$location->location_image}}" width="100" height="80" class="location_image" />
                    </div>
                 ...
                 <div class="form-group form-md-line-input col-md-6">
                    <input type="text" class="form-control" id="contact_numbers" name="contact_numbers" value="{{ $location->contact_numbers }}" placeholder="+966663635,+96651515156,....">
                ...
                <input value="{{ $location->lat }}" type="hidden" id="lat" name="lat">
                <input value="{{ $location->lng }}" type="hidden" id="lng" name="lng">
