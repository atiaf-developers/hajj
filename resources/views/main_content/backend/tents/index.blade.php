...
@section('pageTitle', _lang('app.tents'))
@section('breadcrumb')
<li><a href="{{url('admin')}}">{{_lang('app.dashboard')}}</a> <i class="fa fa-circle"></i></li>
<li><span> {{_lang('app.tents')}}</span></li>

@endsection
@section('js')
<script src="{{url('public/backend/js')}}/tents.js" type="text/javascript"></script>
@endsection
@section('content')
<div class="modal fade" id="addEditTents" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="addEditTentsLabel"></h4>
            </div>

            <div class="modal-body">


                <form role="form"  id="addEditTentsForm"  enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input col-md-12">
                            ...
                            <label for="status">{{_lang('app.gender') }}</label>
                            <span class="help-block"></span>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="form-group form-md-line-input col-md-12">
                            <select class="form-control edited" id="type" name="type">
                                <option  value="1">{{ _lang('app.tent') }}</option>
                                <option  value="2">{{ _lang('app.lounge') }}</option>
                            </select>
                            <label for="status">{{_lang('app.type') }}</label>
                            <span class="help-block"></span>
                        </div>
                        <div class="clearfix"></div>
    ...
    <div class = "panel-body">
        ...
        <div class="table-toolbar">
            <div class="row">
                <div class="col-md-6">
                    <div class="btn-group">
                        <a class="btn green" style="margin-bottom: 40px;" href="" onclick="Tents.add(this);return false;">{{ _lang('app.add_new')}}<i class="fa fa-plus"></i> </a>
                    </div>
                </div>
            </div>
        </div>
